...
pub fn init_default_agent(path: PathBuf) {
    let config = AgentConfig {
        ...
        tools: AgentToolsConfig {
            ...
            shell_access: false,
            brave_search: ToolConfig { enabled: false, settings: Default::default() },
            vector_memory: ToolConfig { enabled: true, settings: Default::default() },
            discord: ToolConfig { enabled: false, settings: Default::default() },
