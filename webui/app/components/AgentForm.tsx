            ...
            <div style={{ maxWidth: '720px', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <Avatar name={form.agent_id || 'new'} size="lg" avatarUrl={avatarDisplayUrl} />
              ...
              <div style={{ display: 'flex', gap: '0.75rem', paddingTop: '0.5rem' }}>
                <button onClick={onCancel} style={{ padding: '0.6rem 1.5rem', borderRadius: '0.375rem', border: '1px solid var(--border)', background: 'transparent', color: 'var(--text-primary)', cursor: 'pointer', fontSize: '0.85rem' }}>
                  Cancel
                </button>
                <div style={{ flex: 1 }} />
                <button
                  onClick={handleSubmit}
                  disabled={submitting || (mode === 'create' && (!form.agent_id.trim() || !form.name.trim())) || (mode === 'edit' && !form.name.trim())}
                  style={{
