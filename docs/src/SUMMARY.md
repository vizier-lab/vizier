...
- [1.2 Quick Start](./getting-started/quick-start.md)
...
<!-- - [3.1 Overview](./development/overview.md) -->
<!-- - [3.2 Adding Tools](./development/adding-tools.md) -->
<!-- - [3.3 Adding Channels](./development/adding-channels.md) -->
<!-- - [3.4 Adding Providers](./development/adding-providers.md) -->

# 4. Reference

<!-- - [4.1 Configuration Reference](./reference/configuration.md) -->
<!-- - [4.2 API Reference](./reference/api.md) -->
<!-- - [4.3 CLI Commands](./reference/cli.md) -->
<!-- - [4.4 Environment Variables](./reference/env-vars.md) -->
